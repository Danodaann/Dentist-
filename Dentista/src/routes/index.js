...
router.get('/Pacientes/Dientes',isAuthenticatedP, async(req,res) => { const Doctor = await User.find({_id:req.params.id , Cedula:req.user.Cedula});
res.render('DientesPaciente.hbs',{Doctor});});
